    ...
    <>
      <div className="bg-gray-200 w-full h-screen flex justify-center items-center">
        <div className="w-[70%] sm:w-120 border rounded-2xl border-gray-200 shadow-xl p-8">
          ...
          <div className="mb-6">
            <button className="w-full flex justify-center items-center gap-4 p-2 rounded border border-gray-300 text-sm">
          ...
          <div className="mb-6">
            <form>
              <div className="mb-6">
                ...
                <input type="text" className="border w-full rounded-lg border-gray-300 py-2 px-2" />
              </div>
              ...
              <button className="w-full rounded-lg bg-primary text-white font-bold py-2 hover:text-gray-700 transition flex items-center justify-center gap-3 mt-2">
                <div className="w-3 h-3 bg-amber-300 animate-spin"></div>로그인
              </button>
            </form>
            <p className="text-sm text-center text-gray-500 mt-3">Lorem ipsum dolor sit amet.</p>
          </div>
        </div>
      </div>
    </>
