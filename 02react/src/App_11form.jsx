...
function App() {
  ...
  const eventHandler = (e) => {
    ...
    // e.target<input type=text name="userid" value="asdfasd">(구조분해할당)
    // e.target {type:"text", name="userid", value="asdfasd"}
    // const {name, value} = {type:'text', name='userid', value='asdfasd'}
